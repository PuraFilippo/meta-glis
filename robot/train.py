...
from robot.dataset import RobotDataset
...
def main():
    ...
    latent_dim = 15  # Latent space dimension (reduced dimensionality)
    alpha = 0
    ...
    model_dir = '../out/robot'  # os.path.join(home_dir, 'meta-glis/numerical_examples/robot/out/robot')
